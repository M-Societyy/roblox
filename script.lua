...
-- Animación de inicio completamente rediseñada y más premium
local function createWelcomeAnimation()
    ...
    for i = 1, 50 do
        ...
        spawn(function()
            while particle.Parent do
                local tween = TweenService:Create(particle, TweenInfo.new(math.random(2, 5), Enum.EasingStyle.Sine), {
                    Position = UDim2.new(math.random(), 0, math.random(), 0),
                    BackgroundColor3 = Color3.fromHSV(tick() % 5 / 5, 1, 1)
                })
                tween:Play()
    ...
    subtitleLabel.Text = "ULTIMATE PREMIUM SCRIPT"
    subtitleLabel.TextColor3 = Color3.fromRGB(255, 255, 255)
    subtitleLabel.TextScaled = true
    subtitleLabel.Font = Enum.Font.Gotham
    subtitleLabel.TextStrokeTransparency = 0
    subtitleLabel.TextStrokeColor3 = Color3.fromRGB(0, 255, 255)
    ...
    loadingFill.BackgroundColor3 = Color3.fromRGB(255, 0, 255)
    ...
    loadingGradient.Parent = loadingFill
    
    spawn(function()
        while titleLabel.Parent do
            titleLabel.TextColor3 = Color3.fromHSV(tick() % 3 / 3, 1, 1)
            subtitleLabel.TextColor3 = Color3.fromHSV((tick() + 1) % 3 / 3, 1, 1)
            wait(0.1)
        end
    end)
    
    local loadingTween = TweenService:Create(loadingFill, TweenInfo.new(3, Enum.EasingStyle.Quad), {
    ...
    spawn(function()
        ...
        for _, particle in pairs(particles) do
            TweenService:Create(particle, TweenInfo.new(1, Enum.EasingStyle.Quad), {
                BackgroundTransparency = 1
            }):Play()
        end
        
        TweenService:Create(titleLabel, TweenInfo.new(1, Enum.EasingStyle.Quad), {
            TextTransparency = 1,
            TextStrokeTransparency = 1
        }):Play()
        
        TweenService:Create(subtitleLabel, TweenInfo.new(1, Enum.EasingStyle.Quad), {
            TextTransparency = 1,
            TextStrokeTransparency = 1
        }):Play()
        
        TweenService:Create(loadingBar, TweenInfo.new(1, Enum.EasingStyle.Quad), {
            BackgroundTransparency = 1
        }):Play()
